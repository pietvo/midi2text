...
MIDIFILE_PUBLIC extern void (*Mf_on)(int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_off)(int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_pressure)(int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_parameter)(int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_pitchbend)(int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_program)(int, int);
MIDIFILE_PUBLIC extern void (*Mf_chanpressure)(int, int);
MIDIFILE_PUBLIC extern void (*Mf_sysex)(int, char*);
MIDIFILE_PUBLIC extern void (*Mf_metamisc)(int, int, char*);
MIDIFILE_PUBLIC extern void (*Mf_sqspecific)(int, char*);
MIDIFILE_PUBLIC extern void (*Mf_seqnum)(int);
MIDIFILE_PUBLIC extern void (*Mf_text)(int, int, char*);
MIDIFILE_PUBLIC extern void (*Mf_eot)();
MIDIFILE_PUBLIC extern void (*Mf_timesig)(int, int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_smpte)(int, int, int, int, int);
MIDIFILE_PUBLIC extern void (*Mf_tempo)(long);
MIDIFILE_PUBLIC extern void (*Mf_keysig)(int, int);
MIDIFILE_PUBLIC extern void (*Mf_arbitrary)(int, char*);
MIDIFILE_PUBLIC extern void (*Mf_error)(char *);
